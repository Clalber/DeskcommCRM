...
Ao cadastrar a URL de webhook no painel da Meta, ela recusava com **"não foi
possível validar a URL de callback ou o token de verificação"** — mesmo com a URL
e o token corretos, copiados da própria tela de Conexões.
