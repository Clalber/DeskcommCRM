  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-4">
      ...
      <div className="flex flex-wrap gap-2" data-testid="radar-counts">
        <Badge variant="error">{data.counts.critico} {t("crítico")}</Badge>
        <Badge variant="warning">{data.counts.em_risco} {t("em risco")}</Badge>
        <Badge variant="info">{data.counts.em_voo} {t("em voo")}</Badge>
      </div>
