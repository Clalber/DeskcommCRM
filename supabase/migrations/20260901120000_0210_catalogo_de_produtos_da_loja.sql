-- ============================================================================
-- 0210 — O CATÁLOGO DE PRODUTOS DA LOJA
-- (renumerada de 0204 ao sincronizar com o projeto de origem: aqui o 0204 é
--  `um_pareamento_pendente_por_organizacao`, já aplicado)
--
