-- 0211 — UM AGENTE PODE INDEXAR MAIS DE UM MATERIAL
-- (renumerada de 0205 ao sincronizar com o projeto de origem: aqui o 0205 é
--  `vocabulario_de_avisos_completo`, já aplicado)
--
...
comment on index public.ai_kbv_version_por_fonte is
  'O número da versão conta POR MATERIAL (semântica da 0181). O índice antigo era por agente e impedia o segundo material do mesmo agente de indexar — migration 0211.';
