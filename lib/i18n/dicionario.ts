...
export const DICIONARIO: Traducoes = {
  ...
  "Tags": { es: "Etiquetas" },
  // ─── Iguais nos dois idiomas, e declaradas de propósito ───
  //
  // O gate `i18n-espanhol-cobre-a-tela` exige entrada em espanhol para TODA
  // chave usada na tela, mesmo quando a tradução é a própria chave — e está
  // certo: sem a linha, "igual porque assim se diz" fica indistinguível de
  // "esqueci", que é exatamente o defeito silencioso que este arquivo já pagou
  // caro. As três primeiras são PADRÕES de formato do date-fns, não frases: o
  // "de" entre dia e mês é o mesmo nos dois idiomas.
