...
export const DICIONARIO: Traducoes = {
  ...
  // mal, porque a ordem das palavras muda entre idiomas.
  Instagram: { es: "Instagram" },
  "Instagram Direct": { es: "Instagram Direct" },
  "Atender as mensagens diretas do Instagram no mesmo Inbox do WhatsApp.": {
    es: "Atender los mensajes directos de Instagram en el mismo Inbox de WhatsApp.",
  },
  "Transporte pendente": { es: "Transporte pendiente" },
  "O canal já existe no banco e no roteamento, mas ainda não é possível conectar uma conta: falta a autorização pela Meta e a entrega de mensagens. Esta tela mostra o que será pedido, para você preparar o lado da Meta enquanto isso.": {
    es: "El canal ya existe en la base de datos y en el enrutamiento, pero todavía no es posible conectar una cuenta: falta la autorización de Meta y la entrega de mensajes. Esta pantalla muestra lo que se pedirá, para que puedas ir preparando el lado de Meta mientras tanto.",
  },
  "Credenciais da conta": { es: "Credenciales de la cuenta" },
  "Cada cliente cria o próprio aplicativo na Meta e cola as credenciais dele aqui — não existe um aplicativo único para todo mundo.": {
    es: "Cada cliente crea su propia aplicación en Meta y pega aquí sus credenciales — no existe una aplicación única para todos.",
  },
  "ID do aplicativo": { es: "ID de la aplicación" },
  "O identificador do app que o dono da conta criou na Meta.": {
    es: "El identificador de la app que el dueño de la cuenta creó en Meta.",
  },
  "Chave secreta do aplicativo": { es: "Clave secreta de la aplicación" },
  "Secreta. Fica cifrada no banco, nunca no arquivo de configuração.": {
    es: "Secreta. Se guarda cifrada en la base de datos, nunca en el archivo de configuración.",
  },
  "Inventado por você; a Meta o devolve ao registrar o webhook, e é assim que confirmamos que é ela.": {
    es: "Lo inventas tú; Meta lo devuelve al registrar el webhook, y así confirmamos que es ella.",
  },
  "Disponível quando a conexão com a Meta estiver implementada": {
  ...
  "ler a conta": { es: "leer la cuenta" },
  "receber e responder mensagens": { es: "recibir y responder mensajes" },
  "uma PESSOA responder até 7 dias depois — a IA não usa": {
    es: "que una PERSONA responda hasta 7 días después — la IA no la usa",
  },
  "Como este canal se comporta": { es: "Cómo se comporta este canal" },
  "A conversa fica aberta por 24 horas a partir da última mensagem do cliente.": {
    es: "La conversación queda abierta por 24 horas a partir del último mensaje del cliente.",
  },
  "Passadas as 24 horas não existe modelo aprovado para reabrir, como há no WhatsApp — quem responde tem que ser uma pessoa. O agente de IA encerra o turno e escala.": {
    es: "Pasadas las 24 horas no existe plantilla aprobada para reabrir, como sí la hay en WhatsApp — quien responde tiene que ser una persona. El agente de IA cierra el turno y escala.",
  },
  "Não há grupos, e a mensagem não é cobrada por unidade.": {
    es: "No hay grupos, y el mensaje no se cobra por unidad.",
  },
  "A credencial vence e precisa ser renovada — algo que o WhatsApp por QR não exige.": {
    es: "La credencial caduca y hay que renovarla — algo que WhatsApp por QR no exige.",
  },
  Conexão: { es: "Conexión" },
