...
# asserções —, o que amarrava a suíte a um publicador só: um fork que publica as
# próprias imagens ficava vermelho sem ter quebrado nada. O que estes casos provam
# é que as três imagens andam na MESMA versão, e isso independe de quem publica.
