...
export const AGENDAMENTOS: Agendamento[] = [
  ...
  { id: "c4", titulo: "Almoço da equipe", responsavelId: "ana", comeca: em(addDays(SEG, 3), 12, 0), termina: em(addDays(SEG, 3), 13, 0), origem: "google", situacao: "confirmado" },
  { id: "c5", titulo: "Consulta", quemSeraAtendido: "Rita Campos", responsavelId: "ana", comeca: em(addDays(SEG, 3), 15, 0), termina: em(addDays(SEG, 3), 15, 30), tipo: "Consulta", origem: "deskcomm", situacao: "confirmado" },
  { id: "c6", titulo: "Procedimento", quemSeraAtendido: "João Bento", responsavelId: "davi", comeca: em(addDays(SEG, 3), 16, 0), termina: em(addDays(SEG, 3), 17, 30), tipo: "Procedimento", origem: "deskcomm", situacao: "aguardando" },
  { id: "c7", titulo: "Retorno", quemSeraAtendido: "Ícaro Melo", responsavelId: "bruno", comeca: em(addDays(SEG, 4), 8, 30), termina: em(addDays(SEG, 4), 9, 0), tipo: "Retorno", origem: "deskcomm", situacao: "cancelado" },
