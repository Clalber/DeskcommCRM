...
## J16 — O follow-up anda em hospedagem sem agendador `[P0]`
...
| # | Caso | Expectativa | Resultado |
|---|------|-------------|-----------|
| J16.1 | Segredo errado é recusado | 403 **e** o enrollment não se move | PASS |
| J16.2 | 1ª batida executa o `wait` | agenda a espera para o futuro, `steps_taken` sobe | PASS |
| J16.3 | 2ª batida, vencido o prazo, avança | `current_node_id` chega ao nó final | PASS |
